...
public class Tag_6_None extends UiAutomatorTestCase{
	public void testTag_2_None() throws UiObjectNotFoundException,InterruptedException,IOException {
		...
		sleep(5000);
		//验证：检查穿越拍照按钮
		UiObject check= new UiObject(new UiSelector().resourceId("cn.jingling.motu.photowonder:id/face_pass_camera"));
		assertTrue("穿越--ok", check.exists());
		}catch(Exception e){
			e.printStackTrace();
		}finally{
