...
public class Tag_24_recommand_en extends UiAutomatorTestCase {
	public void testTag_24_recommand() throws UiObjectNotFoundException,
		...
		UiObject check2 = new UiObject(new UiSelector().resourceId(
				"cn.jingling.motu.photowonder:id/recommend_relative_layout")
