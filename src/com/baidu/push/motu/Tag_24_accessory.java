...
public class Tag_24_accessory extends UiAutomatorTestCase {
	public void testTag_24_accessory() throws UiObjectNotFoundException,
		...
		UiObject check = new UiObject(new UiSelector().text("贴纸"));
