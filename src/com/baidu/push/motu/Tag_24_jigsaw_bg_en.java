...
public class Tag_24_jigsaw_bg_en extends UiAutomatorTestCase{
	public void testTag_24_jigsaw_bg() throws UiObjectNotFoundException,InterruptedException,IOException {
		...
		UiObject check2 = new UiObject(new UiSelector().resourceId(
				"cn.jingling.motu.photowonder:id/welcome_jigsaw_relative_layout")
