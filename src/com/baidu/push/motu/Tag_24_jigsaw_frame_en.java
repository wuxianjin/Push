...
public class Tag_24_jigsaw_frame_en extends UiAutomatorTestCase{
	public void testTag_24_jigsaw_frame() throws UiObjectNotFoundException,InterruptedException,IOException {
		...
		UiObject check = new UiObject(new UiSelector().text("Collage"));
